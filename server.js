...
async function ingestDays(body) {
  if (!(REDIS_URL && REDIS_TOKEN)) return { ok: false, error: "Redis not configured \u2014 replay ingest requires persistence (set UPSTASH_REDIS_URL / UPSTASH_REDIS_TOKEN). Refusing to spend credits.", quota: QUOTA };
